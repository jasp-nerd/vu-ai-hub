...
### 1.1 Psychology = Study of Mind, Brain, and Behavior
- **Mind**: mental activity resulting from biological processes in the brain
- **Behavior**: the totality of observable human (or animal) actions
- **Psychologist**: someone who understands mental life or predicts behavior

### 1.2 Critical Thinking
- **Amiable skepticism**: careful examination of how well evidence supports a conclusion
- Critical thinking skills are essential for evaluating research reported in popular media

### 1.3 Common Biases in Thinking
| Bias | Description |
|------|-------------|
| Confirmation bias | Ignoring evidence that contradicts pre-existing beliefs |
| Illusory correlation | Seeing relationships that do not actually exist |
| After-the-fact explanation | Accepting explanations that seem plausible only after knowing the outcome |
| Mental shortcuts | Taking cognitive shortcuts that can lead to errors |

### 1.4 Why Are People Unaware of Their Weaknesses?
- People lack expertise to judge their own performance (Dunning-Kruger effect)
- Motivated to think well of themselves; may not internalize criticism
- Bottom performers overestimate their abilities the most

### 1.5 Nature/Nurture and the Mind/Body Problem
- **Nature/nurture debate**: are traits biologically innate or acquired through experience? Answer: they interact
- **Mind/body problem**: are mind and body separate, or is the mind a product of brain activity? Modern view: the physical brain enables the mind

### 1.6 Functionalism
- The mind evolved to solve specific problems in the environment
- Human mental activity, behavior, and culture are guided by evolution

### 1.7 Subfields of Psychology
| Area | Focus | Chapters |
|------|-------|----------|
...
- Advances in neuroscience reveal the working brain
- Gut-brain axis: peripheral systems have two-way communication with the brain

---

## Chapter 3 (Part 1): Genetics and Evolution

### 3.15 Genetic Basis of Development
- Human behavior is influenced by genes
- Chromosomes are made of genes; humans have 23 pairs
...
- Many characteristics are **polygenic** (influenced by many genes)

### 3.17 Genes Affect Behavior
- **Behavioral genetics**: how genes and environment interact
- Twin studies and adoption studies reveal heritability
- **Heritability estimates** range from 0 to 1 (population-specific, not individual)
...
- Natural selection requires heritable variation in a population
- Variation arises from random mutations

---

## Chapter 3 (Part 2): The Nervous System
...
|------------------|----------|
| Acetylcholine | Motor control, learning, memory, sleep, dreaming |
...
- Terminated by: **reuptake**, **enzyme deactivation**, or **autoreception**
- **Agonists** enhance neurotransmitter effects; **antagonists** inhibit them

### 3.4 Brain Imaging Technologies
| Technology | Measures | Method |
|------------|----------|--------|
| EEG | Electrical activity | Electrodes on scalp |
| PET | Brain metabolism | Radioactive tracers |
| MRI | Brain structure | Magnetic fields |
| fMRI | Brain function (blood flow) | Magnetic fields |
| TMS | Causal brain-behavior links | Magnetic disruption |

### 3.5 The Cerebral Cortex

![Brain Lobes](/assets/svgi/brain-lobes.svg)

| Lobe | Function |
|------|----------|
| Frontal | Thought, planning, movement, personality, social behavior |
...
| Hypothalamus | Regulates body functions, motivation |
| Hippocampus | Memory formation |
| Amygdala | Threat and fear processing |
| Basal ganglia | Movement planning and reward |
| Insula | Taste, pain, empathy |
| Cerebellum | Coordination of movement and balance |

### 3.9 Brain Stem
- **Medulla**: heart rate, breathing
- **Pons**: connects brain regions, autonomic functions
- **Midbrain**: sensory processing
- **Reticular formation**: alertness and sleep

### 3.11 Peripheral Nervous System
- **Somatic NS**: sensory/motor signals between CNS and body
- **Autonomic NS**: regulates internal environment
  - **Sympathetic**: fight-or-flight (dilates pupils, accelerates heart)
  - **Parasympathetic**: rest-and-digest (constricts pupils, slows heart)
...
|-------|-------------|----------|
| Awake (alert) | Beta | Normal waking |
...
- **Activation-synthesis hypothesis**: dreams = mind making sense of random brain activity

### 4.13 Sleep Disorders
- **Insomnia**: inability to sleep causing daily problems
...
| Type | Effect | Examples | Neurotransmitter System |
|------|--------|----------|------------------------|
| Stimulants | Increase activity | Cocaine, amphetamines, caffeine | Dopamine, norepinephrine |
| Depressants | Decrease activity | Alcohol, barbiturates, benzodiazepines | GABA |
| Opioids | Pain reduction, pleasure | Heroin, morphine, codeine | Endorphins |
| Hallucinogens | Alter perceptions | LSD, psilocybin | Serotonin, glutamate |
| Combination | Mixed effects | Marijuana, MDMA | Multiple systems |
...
### 5.2 Thresholds
- **Absolute threshold**: minimum intensity to detect stimulus 50% of the time
- **Difference threshold (JND)**: minimum change needed to detect a difference
...
- **Object constancy**: size, shape, color, lightness remain stable despite changes
...
- **Secondary reinforcers**: acquire value through conditioning (money, grades)

**Schedules of Reinforcement:**
| Schedule | Description | Resistance to Extinction |
|----------|-------------|------------------------|
| Fixed ratio | After set number of responses | Moderate |
| Variable ratio | After unpredictable number of responses | **Highest** |
...
- Fear can be learned through observation (monkeys learning snake fear) or instruction
...
- **State-dependent memory**: same internal state aids recall
...
- **Blocking**: temporary inability to recall (tip-of-the-tongue)
- **Absentmindedness**: forgetting due to inattention
- **Persistence**: unwanted recurring memories (PTSD)
- **Memory bias**: reconstructing memories to fit current beliefs
- **Source misattribution**: misremembering where a memory came from
  - False fame effect, sleeper effect, cryptomnesia
- **Suggestibility**: biased memories from misleading information (eyewitness testimony)
- **False memories**: created through suggestion or imagination
...
- **Concepts**: mental representations that categorize items
  - **Prototype model**: category has a most typical example
  - **Exemplar model**: category = all examples ever encountered
...
- **Loss aversion**: losses have greater psychological impact than equivalent gains
...
- **Working backward**: start from the goal and work to the current state
- **Insight**: sudden realization of a solution (often by overcoming functional fixedness)
- **Maximizers vs. satisficers**: maximizers seek the best choice (less happy); satisficers seek "good enough" (more happy)
